package com.alencion.api.oauth.service;

import com.alencion.api.exception.domain.OAuth2AuthenticationProcessingException;
import com.alencion.api.user.domain.OAuth2UserInfo;
import com.alencion.api.user.domain.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest userRequest, OAuth2UserInfo oAuth2UserInfo) {
        User newUser = User.builder()
                ...
                .description(oAuth2UserInfo.getDescription())
